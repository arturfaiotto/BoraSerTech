/* Utitilize o código do exercício anterior e adicione a funcionalidade 
de poder buscar alunos por id/nome/professor/idade*/
...
do {
    ...
    switch (menu) {
        ...
        case "4": 
            console.log("\n----- Opção de busca e pesquisa de Aluno -----\n");
        
            console.log("1 - Pesquisar por ID.");
            console.log("2 - Pesquisar por nome");
            console.log("3 - Pesquisar por professor.");
            console.log("4 - Pesquisar por idade.");
            let acao2 = prompt("Escolha uma opção: ");

            do{
                switch(acao2){
                case "1":
                    var busca = parseInt(prompt("Digite o ID do Aluno: "));
                    var retornopesq = arrtotalalunos.filter(obj => obj.id === busca)
                    console.log(retornopesq)
                    validacaomenu = true
                break;
                case "2":
                    var busca = prompt("Digite o nome do Aluno: ");
                    var retornopesq = arrtotalalunos.filter(obj => obj.nome === busca)
                    console.log(retornopesq)
                    validacaomenu = true
                break;
                case "3":
                    var busca = prompt("Digite o nome do professor do Aluno: ");
                    var retornopesq = arrtotalalunos.filter(obj => obj.professor_responsavel === busca)
                    console.log(retornopesq)
                    validacaomenu = true
                break;
                case "4":
                    var busca = parseInt(prompt("Digite a idade do Aluno: "));
                    var retornopesq = arrtotalalunos.filter(obj => obj.idade === busca)
                    console.log(retornopesq)
                    validacaomenu = true
                break;
                default:
